...
\begin{rSection}{Publications (Peer-Reviewed)}
	...
	\begin{flushleft}
	\begin{etaremune}[itemsep=0pt,parsep=.25em]
...
\vfill
\begin{center}
	Source code for this curriculum vitae (CV) is available at: \href{http://github.com/mrhunsak/Hunsaker-CV}{http://github.com/mrhunsak/Hunsaker-CV}
\end{center}
\end{document}